...
export function JoinSpaceDialog({
  ...
  return (
    <Modal
      ...
      onClose={onClose}
      size="lg"
      icon={<GlobeIcon size={18} weight="fill" className="text-primary" />}
      title="Join a space"
      description="Browse public spaces anyone can join."
    >
      <div className="bg-popover sticky top-0 z-10 border-b p-3">
